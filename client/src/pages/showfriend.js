      ...
      if(this.props.ans.length==0)
        {
            return(
                <div>
                <span className="badge badge-danger"><h3>Sorry no companions were found according to your mentioned details.
                We recommend you to modify your location a bit..</h3></span>
                <span className="badge badge-danger"><h3>You can even enter your details so that others can access you in future..</h3></span>
                </div>
